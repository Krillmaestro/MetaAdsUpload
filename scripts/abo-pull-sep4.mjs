...
const TR = JSON.stringify({ since: "2026-09-02", until: "2026-09-04" });
const g = async (p, q = {}) => {
...
writeFileSync("/private/tmp/claude-501/-Users-kristoffermacbook/149ad702-f80b-43ed-9cd9-742554db01ef/scratchpad/abo-data-sep4.json", JSON.stringify(out, null, 1));
for (const c of out) {
  console.log(`\n═══ ${c.name} ═══`);
